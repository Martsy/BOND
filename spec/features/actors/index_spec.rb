...
RSpec.describe 'actors index page', type: :feature do
  before(:each) do
    ...
    @actor2 = Actor.create!(name: 'George Lazenby', age: 30, nationality: 'Australian', image_url: 'https://www.biography.com/.image/ar_8:10%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cg_faces:center%2Cq_auto:good%2Cw_620/MTE5NTU2MzE2NTMwMDUwNTcx/timothy-dalton-20702697-1-402.jpg')
    ...
    @movie1 = @actor1.movies.create!(title: 'Dr. No', year_released: 1962, image_url: 'https://m.media-amazon.com/images/M/MV5BMTk4YzdjOTgtNjM4NS00YjljLThhM2QtYTI3OTQ0OGVhNTMxXkEyXkFqcGdeQXVyNjc1NTYyMjg@._V1_SY1000_CR0,0,659,1000_AL_.jpg')
  ...
  it 'user can see a list of each actors movies' do
    @actor1 = Actor.create!(name: 'Sean Connery', age: 32, nationality: 'Scottish', image_url: 'https://m.media-amazon.com/images/M/MV5BMzcwNTM4MzctYjQzMi00NTA2LTljYWItNTYzNmE1MTYxN2RlXkEyXkFqcGdeQXVyMDI2NDg0NQ@@._V1_SY1000_CR0,0,779,1000_AL_.jpg')
    @actor2 = Actor.create!(name: 'George Lazenby', age: 30, nationality: 'Australian', image_url: 'https://www.biography.com/.image/ar_8:10%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cg_faces:center%2Cq_auto:good%2Cw_620/MTE5NTU2MzE2NTMwMDUwNTcx/timothy-dalton-20702697-1-402.jpg')
    @actor3 = Actor.create!(name: 'Roger Moore', age: 46, nationality: 'English', image_url: 'https://m.media-amazon.com/images/M/MV5BMTQ3Njg5MDkxNl5BMl5BanBnXkFtZTYwNjczMzU0._V1_UY317_CR1,0,214,317_AL_.jpg')
    @actor4 = Actor.create!(name: 'Timothy Dalton', age: 41, nationality: 'Welsh', image_url: 'https://m.media-amazon.com/images/M/MV5BNDE5NDA1OTA4NV5BMl5BanBnXkFtZTcwMDE3NDk0NA@@._V1_SY1000_CR0,0,671,1000_AL_.jpg')
    ...
    expect(page).to have_content(@movie1.year_released)
    expect(page).to have_content(@movie1.image_url)

    expect(page).to have_content(@movie2.title)
    expect(page).to have_content(@movie2.year_released)
    expect(page).to have_content(@movie2.image_url)

    expect(page).to have_content(@movie3.title)
    expect(page).to have_content(@movie3.year_released)
    expect(page).to have_content(@movie3.image_url)

    expect(page).to have_content(@movie4.title)
    expect(page).to have_content(@movie4.year_released)
    expect(page).to have_content(@movie4.image_url)

    expect(page).to have_content(@movie5.title)
    expect(page).to have_content(@movie5.year_released)
    expect(page).to have_content(@movie5.image_url)

    expect(page).to have_content(@movie7.title)
    expect(page).to have_content(@movie7.year_released)
    expect(page).to have_content(@movie7.image_url)

    expect(page).to have_content(@movie14.title)
    expect(page).to have_content(@movie14.year_released)
    expect(page).to have_content(@movie14.image_url)
  end

  it 'user can sort actor by age'
  @actor1 = Actor.create!(name: 'Sean Connery', age: 32, nationality: 'Scottish', image_url: 'https://m.media-amazon.com/images/M/MV5BMzcwNTM4MzctYjQzMi00NTA2LTljYWItNTYzNmE1MTYxN2RlXkEyXkFqcGdeQXVyMDI2NDg0NQ@@._V1_SY1000_CR0,0,779,1000_AL_.jpg')
  @actor2 = Actor.create!(name: 'George Lazenby', age: 30, nationality: 'Australian', image_url: 'https://www.biography.com/.image/ar_8:10%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cg_faces:center%2Cq_auto:good%2Cw_620/MTE5NTU2MzE2NTMwMDUwNTcx/timothy-dalton-20702697-1-402.jpg')
  @actor3 = Actor.create!(name: 'Roger Moore', age: 46, nationality: 'English', image_url: 'https://m.media-amazon.com/images/M/MV5BMTQ3Njg5MDkxNl5BMl5BanBnXkFtZTYwNjczMzU0._V1_UY317_CR1,0,214,317_AL_.jpg')
  @actor4 = Actor.create!(name: 'Timothy Dalton', age: 41, nationality: 'Welsh', image_url: 'https://m.media-amazon.com/images/M/MV5BNDE5NDA1OTA4NV5BMl5BanBnXkFtZTcwMDE3NDk0NA@@._V1_SY1000_CR0,0,671,1000_AL_.jpg')
